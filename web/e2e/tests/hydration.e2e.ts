...
// catch.
describe('Hydration', () => {
	// The home page, and one page that actually reads the chain through the
	// context (the template checks `/demo/`, which this app does not have).
	for (const path of ['/', '/bleeps/']) {
