...
<section class="px-4 text-center">
  <div class="mx-auto">
    ...
    <p class="m-6 text-gray-500 dark:text-gray-200 text-xl">
      Owning a Bleep transforms a mere user into a <span class="text-bleeps">Bleeper</span>. Bleepers are given vote in
      the <span class="text-bleeps">Bleeps DAO</span> and earn a passive revenue from
      <span class="text-bleeps">Melodies</span> created from Bleeps they own. They also get to vote on proposal about the
      DAO treasury which they manage. One Bleep, One Vote.
    </p>
    ...
    <p class="m-6 text-gray-500 dark:text-gray-200 text-xl">
      Melodies are the next steps for Bleeps. A Melody is a sequence of 32 Bleeps fine-tuned by their creator to output
    ...
    <img src={`${base}/bleeps/Core.svg`} alt="Ecosystem" class="mx-auto" />
