<script lang="ts">
	...
	import Feature from '$lib/components/bleeps/Feature.svelte';
	import Showcase from '$lib/components/bleeps/Showcase.svelte';
...
<section class="top">
	...
	<div class="use">
		<h2>Use it:</h2>
		<CopyBlock text={`npx degit wighawag/bleeps your-app-folder`} />
		<p>
			Find out more on
			<a href="https://github.com/wighawag/bleeps#readme" target="_blank" rel="noreferrer">github</a>
		</p>
	</div>
</section>
