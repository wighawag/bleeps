    ...
    function _prepareBuffer(uint256 id, bytes memory buffer) internal pure returns (uint256) {
        unchecked {
            ...
            bytes memory start = bytes.concat(
                ...
                "%20",
                note,
                '%27%2C%20a%20fully%20on-chain%20generated%20sound%20giving%20one%20vote%20in%20the%20Bleeps%20DAO","external_url":"',
