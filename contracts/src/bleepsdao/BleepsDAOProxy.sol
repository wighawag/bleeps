...
/// @title The Bleeps DAO proxy contract
...
contract BleepsDAOProxy is BleepsDAOProxyStorage, BleepsDAOEvents {
    constructor(
        address timelock_,
        address nouns_,
        address vetoer_,
    ...
    function _setImplementation(address implementation_) public {
        require(msg.sender == admin, "BleepsDAOProxy::_setImplementation: admin only");
        require(implementation_ != address(0), "BleepsDAOProxy::_setImplementation: invalid implementation address");
